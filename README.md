...
|------|---------|------|------------|---------|--------|----------|-----|
| 2026-06-08 | [cryptographic-constraint-compressor](https://github.com/dipeshrayg/2026-06-08-cryptographic-constraint-compressor) | Python | 110 | hybrid-constraint-compression | Cryptography | Constraint solving, DPLL with CDCL, Entropy-based heuristics | [▶ run](https://dipeshrayg.github.io/2026-06-08-cryptographic-constraint-compressor/) · [⚡ codespaces](https://codespaces.new/dipeshrayg/2026-06-08-cryptographic-constraint-compressor) |
